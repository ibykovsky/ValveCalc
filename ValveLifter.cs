...
namespace ValveCalc
{
    ...
    internal class ValveLifterCatalog
    {
        static ValveLifterCatalog[] catalog = {
            ...
            new ValveLifterCatalog { Nominal = 3142, Ford = "5103638", Mazda = "LF01-12-547" },
            ...
            new ValveLifterCatalog { Nominal = 3262, Ford = "0000000", Mazda = "LF01-12-554" },
            new ValveLifterCatalog { Nominal = 3282, Ford = "5103647", Mazda = "LF01-12-555" },
            new ValveLifterCatalog { Nominal = 3302, Ford = "0000000", Mazda = "LF01-12-556" },
            new ValveLifterCatalog { Nominal = 3322, Ford = "0000000", Mazda = "LF01-12-557" },
            ...
            new ValveLifterCatalog { Nominal = 3462, Ford = "0000000", Mazda = "LF01-12-565" },
            new ValveLifterCatalog { Nominal = 3482, Ford = "5103657", Mazda = "LF01-12-566" },
            new ValveLifterCatalog { Nominal = 3502, Ford = "0000000", Mazda = "LF01-12-567" },
            ...
            new ValveLifterCatalog { Nominal = 3725, Ford = "0000000", Mazda = "LF01-12-578" }
        };
